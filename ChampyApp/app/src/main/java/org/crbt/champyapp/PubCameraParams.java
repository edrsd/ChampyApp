...
public class PubCameraParams extends AbstractNodeMain {
    ...
    public GraphName getDefaultNodeName() {
        return GraphName.of("PublicadorCameraParams");
    }

    @Override
    public void onStart(ConnectedNode connectedNode) {

        final Publisher<Int32MultiArray> publicador=connectedNode.newPublisher("camera_params",Int32MultiArray._TYPE);
