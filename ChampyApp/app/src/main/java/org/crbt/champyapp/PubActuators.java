...
public class PubActuators extends AbstractNodeMain {
    private static final java.lang.String TAG = PubActuators.class.getSimpleName();
    ...
    public GraphName getDefaultNodeName() {
        return GraphName.of("PublicadorActuadores");
    }

    @Override
    public void onStart(ConnectedNode connectedNode) {

        final Publisher<Int32MultiArray> publicador=connectedNode.newPublisher("actuadores_app",Int32MultiArray._TYPE);
